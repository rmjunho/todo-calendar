...
const STR = {
  ko: {
    ...
    'exp.title': '이미지로 내보내기',
    'exp.memo': '카테고리·메모 포함',
    'exp.hint': '기본은 꺼짐입니다 — 개인적인 내용이 이미지로 나가지 않게',
    'exp.share': '공유',
    'exp.save': '저장',
  ...
  en: {
    ...
    'list.memoMore': 'Show the full note',
    'list.memoLess': 'Collapse the note',
    'item.allDay': 'All day',
    ...
    'exp.memo': 'Include category & notes',
    'exp.hint': 'Off by default, so private notes stay out of the image',
    'exp.share': 'Share',
    'exp.save': 'Save',
