...
const STR = {
  ko: {
    ...
    // 만 14세 미만일 때만 보이는 법정대리인 정보
    'ag.gTitle': '보호자(법정대리인) 정보',
    'ag.gWhy': '만 14세 미만은 법정대리인의 동의가 필요합니다. 동의 확인 목적으로만 쓰이며, 다른 곳에 제공하지 않습니다.',
    'ag.gName': '보호자 성명',
    'ag.gNamePh': '부모님 또는 보호자 성함',
    'ag.gPhone': '보호자 연락처',
    'ag.needGName': '보호자(법정대리인) 성명을 입력해 주세요.',
    'ag.needGPhone': '보호자(법정대리인) 연락처를 입력해 주세요.',
    ...
    'adm.guardian': (n, p) => '보호자 ' + n + ' · ' + p,
    'adm.guardianNone': '보호자 정보 없음',
    'adm.pending': '회원가입 신청',
    'adm.all': '전체 회원',
  ...
  en: {
    ...
    'ag.gTitle': 'Legal guardian',
    'ag.gWhy': 'Under-14 accounts need a legal guardian’s consent. Used only to confirm that consent, and never shared.',
    'ag.gName': 'Guardian’s name',
    'ag.gNamePh': 'Parent or guardian',
    'ag.gPhone': 'Guardian’s phone',
    'ag.needGName': 'Enter the legal guardian’s name.',
    'ag.needGPhone': 'Enter the legal guardian’s phone number.',
    ...
    'adm.guardian': (n, p) => 'Guardian ' + n + ' · ' + p,
    'adm.guardianNone': 'No guardian on file',
